...
public interface SearchStrategy {
     ...
     */
    int find(DocumentProvider src, String target, int start, int end, boolean isCaseSensitive, boolean isWholeWord);
     ...
     * @return charOffset of found string; -1 if not found
     */
    int wrappedFind(DocumentProvider src, String target, int start, boolean isCaseSensitive, boolean isWholeWord);
