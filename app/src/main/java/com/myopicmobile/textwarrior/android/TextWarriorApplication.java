...
public class TextWarriorApplication extends Activity implements ProgressObserver, RowListener, SelectionModeListener,
    ...
    private final OnCancelListener cancelSaveCallback = dialog -> {
    ...
    private Dialog createOpenAgainDialog(AlertDialog.Builder builder) {
        ...
        builder.setNeutralButton(R.string.dialog_button_go_back, (dialog, id) -> {
            dialog.dismiss();
    ...
    private Dialog createSaveAgainDialog(AlertDialog.Builder builder) {
        builder.setTitle(_dialogErrorMsg);
        builder.setIcon(android.R.drawable.ic_dialog_alert);
        builder.setNeutralButton(R.string.dialog_button_save_different_name, (dialog, id) -> {
            dialog.dismiss();
    ...
    private Dialog createConfirmOverwriteDialog(AlertDialog.Builder builder) {
        ...
        builder.setPositiveButton(R.string.dialog_button_overwrite, (dialog, id) -> {
            dialog.dismiss();
    ...
    private Dialog createPromptSaveDialog(AlertDialog.Builder builder) {
        ...
        builder.setIcon(android.R.drawable.ic_dialog_alert);
        builder.setPositiveButton(R.string.dialog_button_save, (dialog, id) -> {
            dialog.dismiss();
            TextWarriorApplication.this.onSave();
        });
        builder.setNeutralButton(R.string.dialog_button_discard, (dialog, id) -> {
            dialog.dismiss();
    ...
    private Dialog createGotoLineDialog(AlertDialog.Builder builder) {
        ...
        final EditText lineNumberField = content.findViewById(
    ...
    private Dialog createOpenRecentFileDialog(AlertDialog.Builder builder) {
        ...
        _recentFilesLayout = (FrameLayout) getLayoutInflater().inflate(R.layout.recent_filelist, null);
    ...
    private void populateRecentFilesDialog(Dialog dialog) {
        ...
        if (fileList.size() > 0) {
            ...
            ArrayList<IconifiedText> iconifiedEntries = new ArrayList<>();
    ...
    private Dialog createStatisticsDialog(AlertDialog.Builder builder) {
        ...
        builder.setNeutralButton(android.R.string.ok, (dialog, id) -> dialog.dismiss());
    ...
    private void updateStatisticsDialog() {
        TextView t = _statisticsLayout.findViewById(R.id.statistics_word_count);
        t.setText(Integer.toString(_statistics.wordCount));

        t = _statisticsLayout.findViewById(R.id.statistics_char_count);
        t.setText(Integer.toString(_statistics.charCount));

        t = _statisticsLayout.findViewById(R.id.statistics_char_no_whitespace_count);
        t.setText(Integer.toString(_statistics.charCount - _statistics.whitespaceCount));

        t = _statisticsLayout.findViewById(R.id.statistics_row_count);
        t.setText(Integer.toString(_statistics.lineCount));

        DocumentProvider doc = _editField.createDocumentProvider();

        t = _statisticsLayout.findViewById(R.id.statistics_format);
        t.setText(doc.getEncodingScheme());

        t = _statisticsLayout.findViewById(R.id.statistics_line_terminator_style);
    ...
    private Dialog createRecoveryFailedDialog(AlertDialog.Builder builder) {
        ...
        builder.setNeutralButton(R.string.menu_help, (dialog, id) -> {
            removeDialog(DIALOG_RECOVERY_FAILED);
    ...
    protected void onPrepareDialog(int id, Dialog dialog) {
        switch (id) {
            ...
            case DIALOG_SAVE_AGAIN:
                dialog.setTitle(_dialogErrorMsg);
                break;
